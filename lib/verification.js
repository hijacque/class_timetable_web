...
const changePassword = async (req, res, next) => {
    ...
    // Check if first login, if id from cookie
    ...
    } else if (confirmation.length != 0 && confirmation != password) {
    ...
    if (!valid) {
        res.locals.msg_title = "Invalid password"
        res.locals.msg_body = textAlert
